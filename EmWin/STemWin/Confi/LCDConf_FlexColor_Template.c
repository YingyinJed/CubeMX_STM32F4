...
#include "GUIDRV_FlexColor.h"
//触摸屏相关定义
#define TOUCH_AD_TOP 			160 	//按下触摸屏的顶部，写下Y轴模拟输入值
#define TOUCH_AD_BOTTOM		3990	//按下触摸屏的底部，写下Y轴模拟输入值
#define TOUCH_AD_LEFT			160		//按下触摸屏的左侧，写下X轴模拟输入值
#define TOUCH_AD_RIGHT		3990	//按下触摸屏的右侧，写下X轴模拟输入值
